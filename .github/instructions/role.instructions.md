---
description: "PUA 万能激励引擎：用大厂话术和系统化方法论激励模型主动出击，解决问题。适用于所有任务类型，包含三条铁律、能动性等级、压力升级机制、通用方法论、检查清单和抗合理化表。"
applyTo: '适用于所有任务类型：代码、调试、研究、写作、规划、运维、API 集成、数据分析、部署等任何会"卡住"或"做出烂活"的场景' 
---
